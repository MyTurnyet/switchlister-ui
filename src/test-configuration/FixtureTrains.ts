...
export const industryXmHtNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 1',
...
export const industryXmNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 2',
  [CarType.XM],
);
export const industryXmNoCars = new Industry(industryXmNoCarsState);
export const industryHtNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 3',
  [CarType.HT],
);
export const industryHtNoCars = new Industry(industryHtNoCarsState);
export const industryXmoNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 4',
  [CarType.XMO],
);
export const industryXmoNoCars = new Industry(industryXmoNoCarsState);
export const industryXmXmoNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 5',
  [CarType.XM, CarType.XMO],
);
export const industryXmXmoNoCars = new Industry(industryXmXmoNoCarsState);
export const industryAllNoCarsState: IndustryState = createIndustryState(
  station0State,
  'Industry 6',
  [CarType.All],
);
